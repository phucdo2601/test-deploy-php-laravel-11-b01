    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.brand.update', []) }}" method="POST"
                ...
                @error('name') <span class="alert alert-danger text-content">{{$message}}</span>
                ...
                @error('slug') <span class="alert alert-danger text-content">{{$message}}</span>
                ...
                @error('image') <span class="alert alert-danger text-content">{{$message}}</span>
